            ...
            <main className='booking'>
                ...
                <h1 className='booking__heading'>FIND A CRUISE </h1>
                    <div className='booking__details'>
                        ...
                        <option value="" disabled selected hidden>Sail To</option>
                        ...
                        <option value="" disabled selected hidden>Depart From</option>
                        <option></option>
                        ...
                        <button onClick={handleNavigate} className='booking__button'>SEARCH CRUISES</button>
                    </div>
            </main>
       </section>
