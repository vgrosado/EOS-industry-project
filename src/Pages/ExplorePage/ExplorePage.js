            ...
            <div className='explore__div'>
                <div className='explore__hero'>
                    ...
                    <div className='explore__header'>
                        ...
                        <h1 className='explore__text'>4 Night Bahamas & Perfect Day Cruise</h1>
                    </div>
                    ...
                    <p className='explore__date'>Sailing from Mon, Apr 08 2024</p><p className='explore__date'> ( + 9 Additional Dates! )</p>
                    </div>
                    </section>
                </div>
            </div>
